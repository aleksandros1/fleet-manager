...
async function S(e, { request: t, assetsFetcher: s, ctx: r }, { path: a, searchParams: o }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = P(await s.fetch(I(c, e.path ?? a))), e.headers && x(n.headers, e.headers);
        break;
      }
      case "static": {
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let o = W(e, fe), n = await r.get(a, { softTags: o });
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.7597230567136866.mjs.map
